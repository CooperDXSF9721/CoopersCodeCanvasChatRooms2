...
// ==================== Camera & Microphone System (PRIVATE ROOMS ONLY) ====================
let localStream = null;
let mediaEnabled = false; // Single state for both camera AND microphone
...
async function setupCameraForRoom(roomId) {
  ...
  allCamerasRef.on('child_added', async snapshot => {
    ...
    if (sessionId !== userSessionId && data.enabled && mediaEnabled) {
...
// CHANGED: Single toggle for both camera AND microphone
...
// CHANGED: Single button update function
...
// ==================== Page Management (PRIVATE ROOMS ONLY) ====================
...
window.addEventListener('load', () => {
  ...
  // CHANGED: Single button for both camera and mic
  if (toggleCameraBtn) {
